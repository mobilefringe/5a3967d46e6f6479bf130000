require.config({
  paths: {
    ...
    'vue-dropdown' : 'https://cdn.jsdelivr.net/npm/vue-popover@1.6.0/dist/vue-popover.min'
  }
});

require(['Vue', 'vue2-filters', 'vue_router', 'routes', 'store', 'vue-i18n', 'locales', 'moment', "vue-meta","vue-select","vue-dropdown"], function (Vue, Vue2Filters, VueRouter, appRoutes, store, VueI18n, messages, moment, Meta, VueSelect, VueDropDwn) {
  Vue.use(Meta);
  Vue.use(VueRouter);
  Vue.use(Vue2Filters);
  Vue.use(VueI18n);
