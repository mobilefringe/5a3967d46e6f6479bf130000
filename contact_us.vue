        ...
        <div class="margin_25_across padding_top_40">
            <div class="row"> 
                <div class="col-sm-8 contact_contents">
                    <img style="margin-bottom:20px;"  src='//codecloud.cdn.speedyrails.net/sites/5af082f76e6f6450e9040000/image/jpeg/1521735730000/Contact_Us.jpg' alt="plaza">
        ...
        return Vue.component("contact-us-component", {
            ...
            created(){
                ...
                this.$store.dispatch('LOAD_PAGE_DATA', {
                    url: host_name + "/pages/eastgate-contact-us.json"
                }).then(response => {
