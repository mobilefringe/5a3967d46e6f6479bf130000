			...
			<div class="row promo_dets is-table-row" v-for="promo in jobs">
				<div class="col-sm-7" >
					<div class="promo_div_image"  v-lazy-container="{ selector: 'img' }">
						<img :data-src="promo.store.store_front_url_abs" data-loading='//codecloud.cdn.speedyrails.net/sites/5af082f76e6f6450e9040000/image/png/1521035009104/Screen Shot 2018-03-14 at 9.43.24 AM.png' alt=""/>
					</div>
				</div>
					...
					<div class="promo_feature_share row is-table-row">
    					<span class="feature_read_more col-sm-6">
    						<router-link :to="'/jobs/'+promo.slug" class="mobile_readmore" >
    							<p class="feature-readmore">View Job Details <i class="fa fa-chevron-right pull-right" aria-hidden="true"></i></p>
    						</router-link>
    					</span>
