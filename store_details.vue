	...
	<div class="page_container" v-if="currentStore">
		...
		<div class="menu-container hidden-phone ">
			<div class="menu-div page_container">
				<div v-for="item in menu_items" :id="item.parent_id" :class="item.parent_class_list">
					<router-link  :to="item.href" :id="item.id" class="all_caps dropdown">
						<a href="" class="menu_link" :id="item.name.id" @click="item.show_sub_menu = !item.show_sub_menu">{{item.name}} </a>
						<transition name="custom-classes-transition" enter-active-class="animated fadeIn" leave-active-class="animated fadeOut">
							<div class="dropdown-menu" v-if="item.sub_menu" v-show="item.show_sub_menu" >
								<router-link class="dropdown-item" v-for="sub_menu in item.sub_menu" :to="sub_menu.href">{{sub_menu.name}}</router-link>
							</div>
						</transition>
					</router-link>
				</div>
