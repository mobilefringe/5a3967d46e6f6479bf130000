		...
		<div class="page_container">
			<div class="store-list-left-block col-sm-4 padding_top_20">
		        ...
		        <div id="mapsvg_store_detail_1" class="show_phone">
					...
					<mapplic-png-map ref="mapplic_ref" :height="500" :minimap= "false" :deeplinking="false" :sidebar="false" :hovertip="true" :storelist="allStores" :floorlist="floorList" :bindLocationOpened="true" :svgWidth="1300" :svgHeight="787"  v-if="mobile_store"></mapplic-png-map>
				</div>
			...
			<div class="col-sm-8">
				<div id="mapsvg_store_detail" class="padding_top_20">
					...
					<mapplic-png-map ref="mapplic_ref" :height="500" :minimap= "false" :deeplinking="false" :sidebar="false" :hovertip="true" :storelist="allStores" :floorlist="floorList" :bindLocationOpened="true" :svgWidth="1300" :svgHeight="787" :showPin="true" v-if="!mobile_store"></mapplic-png-map>
				</div>
			</div>
		</div>
	</div>
