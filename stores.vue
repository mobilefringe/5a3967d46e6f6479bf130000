		...
		<div class="page_container">
			<div class="store-list-left-block col-sm-4 padding_top_20">
		        ...
		        <div id="mapsvg_store_detail_1" class="show_phone">
					<mapplic-png-map ref="pngmaprefmobile" :height="500" :minimap= "false" :deeplinking="false" :sidebar="false" :hovertip="true" :storelist="allStores" :floorlist="floorList" :bindLocationOpened="true" :svgWidth="property.map_image_width" :svgHeight="property.map_image_height"  v-if="mobile_store"></mapplic-png-map>
				</div>
			...
			<div class="col-sm-8 padding_top_20">
				<div id="mapsvg_store_detail" class=" map">
					...
					<mapplic-png-map ref="pngmap_ref" :height="500" :minimap= "false" :deeplinking="false" :sidebar="false" :hovertip="true" :storelist="allStores" :floorlist="floorList" :bindLocationOpened="true" :svgWidth="property.map_image_width" :svgHeight="property.map_image_height"v-if="!mobile_store"></mapplic-png-map>
				</div>
			</div>
		</div>
	</div>
