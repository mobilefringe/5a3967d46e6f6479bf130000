		...
		<div class="page_container">
			...
			<div class="col-sm-8">
				<div id="mapsvg_store_detail" class="padding_top_20">
					...
					<mapplic-png-map ref="mapplic_ref" :height="500" :minimap= "false" :deeplinking="false" :sidebar="false" :hovertip="true" :storelist="allStores" :floorlist="floorList" :bindLocationOpened="true" :svgId="'Layer_1'" :svgWidth="1300" :svgHeight=""></mapplic-png-map>
				</div>
			</div>
		</div>
	</div>
