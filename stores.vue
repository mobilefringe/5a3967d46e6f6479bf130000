		...
		<div class="page_container">
			...
			<div class="col-sm-8">
				<div id="mapsvg_store_detail" class="padding_top_20">
					...
					<mapplic-png-map ref="pngmap_ref" :height="500" :minimap= "false" :deeplinking="false" :sidebar="false" :hovertip="true" :storelist="allStores" :floorlist="floorList" :bindLocationOpened="true" :svgWidth="property.map_image_width" :svgHeight="787" :showPin="true" v-if="!mobile_store"></mapplic-png-map>
				</div>
			</div>
		</div>
	</div>
