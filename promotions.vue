<template>
	<div class="container"><!-- for some reason if you do not put an outer container div this component template will not render -->
		...
		<div class="promo_container" v-if="processedPromos.length > 0">
         ...
         <!--                   </network>-->
    					<!--</div>-->
    					<social-sharing :url="shareURL(promo.slug)" :title="promo.title" :description="currentEvent.body" :quote="truncate(currentEvent.description)" twitter-user="ShopCanyonCrest" :media="currentEvent.image_url" inline-template class="text-right  col-sm-6">
