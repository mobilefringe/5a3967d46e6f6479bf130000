			...
			<div class="row promo_dets text-left" v-for="promo in processedPromos">
				...
				<div class="col-sm-5 promo_div_dets">
					...
					<div class="row is-table-row">
    					...
    					<social-sharing :url="shareURL(currentEvent.slug)" :title="currentEvent.title" :description="currentEvent.body" :quote="truncate(currentEvent.description)" twitter-user="ShopCanyonCrest" :media="currentEvent.image_url" inline-template class="text-right  col-sm-6">
