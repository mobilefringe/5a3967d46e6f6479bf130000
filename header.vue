    			...
    			<div class="col-sm-6 text_left no_padding">
    			    <div class="header-logos">
        				...
        				<div class="header-ribbon">
        				    <!--<a target="_blank" href="https://kingsleyassociates.com/kingsley-excellence" rel="noopener noreferrer" aria-label="Visit Kingley Associates website">-->
                <!--                <img height="100px" width="100px" src="http://docs.kingsleyportal.com/Images/Awards/Commercial2019Emblem.svg" alt="2019 Kingsley Excellence Tenant Satisfaction Emblem" alt="2019 Kingsley Excellence Tenant Satisfaction Emblem" />-->
                <!--            </a>-->
        				</div>
    			    </div>
    					...
    					<div class="opened_mobile_menu" >
    						...
    						<ul>
    							<li v-for="item in menu_items">
    								<router-link :class="{red_highlight: item.href == '/events/eastgate-covid-19-update'}" :to="item.href" :id="item.id" class="all_caps">{{item.name}} </router-link>
    	...
    	<div class="menu-container hidden-phone ">
    		<div class="menu-div page_container">
    			<div v-for="item in menu_items" :class="item.parent_class_list" style="display: inline-block;padding: 0 20px;">
    				<router-link :class="{red_highlight: item.href == '/events/eastgate-covid-19-update'}" :to="item.href" class="all_caps menu_link"  :id="item.name.id" exact v-if="item.sub_menu == undefined">
    					{{item.name}}
    				</router-link>
