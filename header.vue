    		...
    		<div class="header page_container">
    			<div class="col-sm-6 text_left no_padding">
    				<router-link to="/" exact>
    					<img class="site-logo" src="//codecloud.cdn.speedyrails.net/sites/5af082f76e6f6450e9040000/image/png/1516652184126/ES_logo_red.png">
    				</router-link>
    				...
    				<div class="newsletter-div">
    					<div class="newsletter_box" style="margin-bottom:5px">
    						...
    						<div class="input_box">
    							...
    							<router-link style="background-color:transparent;" :to="'/newsletter?email='+ newsletter_email" ><img src="//codecloud.cdn.speedyrails.net/sites/5af082f76e6f6450e9040000/image/png/1511797731769/newsletter.png"></router-link>
    						</div>
    						<!--</form>-->
    					</div>
    				...
    				<div class="mobile_menu_container" v-show="show_mobile_menu">
    					<div class="opened_mobile_menu" >
    						<div class="text-left" style="padding-bottom: 20px;border-bottom: 1px solid #fff;">
    							<img src="//codecloud.cdn.speedyrails.net/sites/5af082f76e6f6450e9040000/image/png/1513713349903/ES_logo_2.png"  alt="">
