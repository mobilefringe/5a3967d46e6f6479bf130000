    		...
    		<div class="header page_container">
    			<div class="col-sm-6 text_left no_padding">
    				...
    				<span class="pull-right show_phone">
    					<router-link style="background-color:transparent;" to="/newsletter" ><img src="//codecloud.cdn.speedyrails.net/sites/5af082f76e6f6450e9040000/image/png/1511797731769/newsletter.png" class="mobile_newsletter_btn" alt="Newsletter signup icon"></router-link>
    			...
    			<div class="col-sm-6 hidden_phone">
    				<div class="social-div social_icons">
    					...
    					<a href="http://www.twitter.com/EastgateSquare" target="_blank" class="social_link_icon social_twitter" alt="Eastgate Twitter"></a>
    				</div>
