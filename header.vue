    		...
    		<div class="header page_container">
    			<div class="col-sm-6 text_left no_padding">
    				<router-link to="/" exact>
    					<img class="site-logo" src="//codecloud.cdn.speedyrails.net/sites/5a3967d46e6f6479bf130000/image/png/1516652184126/ES_logo_red.png">
    				</router-link>
    				<span class="pull-right show_phone">
    					<router-link style="background-color:transparent;" to="/newsletter" ><img src="//codecloud.cdn.speedyrails.net/sites/5a3967d46e6f6479bf130000/image/png/1511797731769/newsletter.png" class="mobile_newsletter_btn"></router-link>
    				...
    				<div class="newsletter-div">
    					<div class="newsletter_box" style="margin-bottom:5px">
    						...
    						<div class="input_box">
    							...
    							<router-link style="background-color:transparent;" :to="'/newsletter?email='+ newsletter_email" ><img src="//codecloud.cdn.speedyrails.net/sites/5a3967d46e6f6479bf130000/image/png/1511797731769/newsletter.png"></router-link>
    						</div>
    						<!--</form>-->
    					</div>
    					<div id="search-form" class="search-form">
    						<div class="input_box">
    							<search-component :list="allStores" placeholder="SEARCH" :suggestion-attribute="suggestionAttribute" v-model="search_result" @select="onOptionSelect" class="text-left">
    							...
    							<img src="//codecloud.cdn.speedyrails.net/sites/5a3967d46e6f6479bf130000/image/png/1514998294110/search_icon.png" id="search_icon"> 
    						</div>
    				...
    				<div class="mobile_menu_container" v-show="show_mobile_menu">
    					<div class="opened_mobile_menu" >
    						<div class="text-left" style="padding-bottom: 20px;border-bottom: 1px solid #fff;">
    							<img src="//codecloud.cdn.speedyrails.net/sites/5a3967d46e6f6479bf130000/image/png/1513713349903/ES_logo_2.png"  alt="">
    						...
    						<div class="social_icons_menu show_phone text-center">
    							...
    							<img src="//codecloud.cdn.speedyrails.net/sites/5a1f136e6e6f6472c6240000/image/png/1512590798000/fb.png" class="" alt="">
    							</a>
