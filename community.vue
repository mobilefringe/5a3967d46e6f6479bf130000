<template>
    <div class="page_container" id="community_container"> <!-- for some reason if you do not put an outer container div this component template will not render -->
                ...
                validateBeforeSubmit() {
                    if(this.correctValNum === this.validaNum) {
                        ...
                        if (result) {
                                ...
                                send_data = {};
                                send_data.url= this.property.mm_host""
