...
<style>
    ...
    #community_container .modal-mask {
        position: fixed;
        z-index: 9998;
        top: 0;
        left: 0;
    ...
    #community_container .modal-wrapper {
        display: table-cell;
    ...
    #community_container .modal-header {
        border-bottom: none;
    }
    ...
    #community_container .modal-footer {
      /*margin: 20px 0;*/
      border-top: none;
    }
    
    #community_container .modal-default-button {
        float: right;
    }
    ...
    #community_container .modal-enter {
        opacity: 0;
    }
    
    #community_container .modal-leave-active {
        opacity: 0;
    }
    
    #community_container .modal-enter .modal-container,
    #community_container .modal-leave-active .modal-container {
                ...
                validateBeforeSubmit() {
                    ...
                    this.$validator.validateAll().then((result) => {
                        if (result && (this.correctValNum === this.validaNum)) {
                            ...
                            formatted_formdata.send_to = "sankavy@mobilefringe.com";//"BMiele@Bentallkennedy.com,kkelly@bentallkennedy.com,swhitaker@bentallkennedy.com";
